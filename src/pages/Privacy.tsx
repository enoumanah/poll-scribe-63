          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Welcome to PollHub. We respect your privacy and are committed to
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We store the polls you create, including questions, options,
                    and voting results. Private polls are only accessible via
                    secure share links.
                  </p>
                </div>
                <div>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <li>
                  To enable poll creation, sharing, and voting functionality
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                sensitive data and secure authentication protocols.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                described in this policy. Public poll results may be visible to
                all users, while private polls are only accessible via secure
                share links.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                We use local storage to maintain your login session and remember
                your theme preferences. No tracking cookies are used for
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                via the contact information provided on our platform.
              </p>
            </section>
